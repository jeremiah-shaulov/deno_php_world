...
```ts
import {g, c} from 'https://deno.land/x/php_world@v0.0.38/mod.ts';
// ...
...
```ts
import {g, c, settings} from 'https://deno.land/x/php_world@v0.0.38/mod.ts';
...
```ts
import {g} from 'https://deno.land/x/php_world@v0.0.38/mod.ts';
...
```ts
import {g, c, php} from 'https://deno.land/x/php_world@v0.0.38/mod.ts';
...
```ts
import {php} from 'https://deno.land/x/php_world@v0.0.38/mod.ts';
...
```ts
import {g, c, settings, PhpInterpreter} from 'https://deno.land/x/php_world@v0.0.38/mod.ts';
...
```ts
import {g, php} from 'https://deno.land/x/php_world@v0.0.38/mod.ts';
...
```ts
import {g, c, InterpreterError} from 'https://deno.land/x/php_world@v0.0.38/mod.ts';
...
```ts
import {g, InterpreterExitError} from 'https://deno.land/x/php_world@v0.0.38/mod.ts';
...
```ts
import {g, c, PhpInterpreter} from 'https://deno.land/x/php_world@v0.0.38/mod.ts';
...
```ts
import {g, c, php, settings} from 'https://deno.land/x/php_world@v0.0.38/mod.ts';
...
```ts
import {start_proxy, PhpRequest} from 'https://deno.land/x/php_world@v0.0.38/mod.ts';
...
```ts
import {php, settings} from 'https://deno.land/x/php_world@v0.0.38/mod.ts';
import {readAll} from 'https://deno.land/std@0.203.0/streams/mod.ts';
...
Another option is to download the interpreter script [from here](https://deno.land/x/php_world@v0.0.38/php/deno-php-world.php),
